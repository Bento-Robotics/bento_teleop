...
class Bento_Teleop(Node):
    ...
    def joy_callback(self, msg):
        ...
        self.arm_point.x += msg.axes[self.get_param_val('axis.linear').integer_value] * throttle
        self.arm_point.y += msg.axes[self.get_param_val('axis.angular').integer_value] * throttle
